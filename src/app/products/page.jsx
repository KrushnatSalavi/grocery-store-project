                        ...
                        <div className='productSlider py-1'>
                            ...
                            >
                                <SwiperSlide className='py-3 px-2'>
                                    <div className='Productitem shadow-md max-w-full bg-white rounded-md'>
                                        <Link href={"/"} className='img overflow-hidden flex p-4 '>
                                            <img src={"/Popular1.jpg"} alt='product img ' className='transition hover:scale-105 h-30 w-40'></img>
                                        </Link>
                                ...
                                <SwiperSlide className='py-3 px-2'>
                                    <div className='Productitem shadow-md max-w-full bg-white rounded-md'>
                                        <Link href={"/"} className='img overflow-hidden flex p-4 '>
                                            <img src={"/product1.png"} alt='product img ' className='transition hover:scale-105 h-30 w-40'></img>
                                        </Link>
                                        <div className='info py-3 flex flex-col gap-1'>
                                ...
                                <SwiperSlide className='py-3 px-2'>
                                    <div className='Productitem shadow-md max-w-full bg-white rounded-md'>
                                        <Link href={"/"} className='img overflow-hidden flex p-4 '>
                                            <img src={"/Popular3.jpg"} alt='product img ' className='transition hover:scale-105 h-30 w-40'></img>
                                        </Link>
                                        <div className='info py-3 flex flex-col gap-1'>
                                ...
                                <SwiperSlide className='py-3 px-2'>
                                    <div className='Productitem shadow-md max-w-full bg-white rounded-md'>
                                        <Link href={"/"} className='img overflow-hidden flex p-4 '>
                                            <img src={"/Popular4.jpg"} alt='product img ' className='transition hover:scale-105 h-30 w-40'></img>
                                        </Link>
                                        <div className='info py-3 flex flex-col gap-1'>
                                ...
                                <SwiperSlide className='py-3 px-2'>
                                    <div className='Productitem shadow-md max-w-full bg-white rounded-md'>
                                        <Link href={"/"} className='img overflow-hidden flex p-4 '>
                                            <img src={"/Fetured5.jpg"} alt='product img ' className='transition hover:scale-105 h-30 w-40'></img>
                                        </Link>
                                        <div className='info py-3 flex flex-col gap-1'>
                                ...
                                <SwiperSlide className='py-3 px-2'>
                                    <div className='Productitem shadow-md max-w-full bg-white rounded-md'>
                                        <Link href={"/"} className='img overflow-hidden flex p-4 '>
                                            <img src={"/Fetured6.jpg"} alt='product img ' className='transition hover:scale-105 h-30 w-40'></img>
                                        </Link>
                                        <div className='info py-3 flex flex-col gap-1'>
