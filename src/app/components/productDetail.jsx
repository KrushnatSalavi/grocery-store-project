  ...
  return (
    <section className="container mx-auto py-10">
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-4">
          ...
          <div className="flex gap-3 mt-4">
            <Image src="/coD2.jpg" alt="Product" width={70} height={70} className="border p-1 rounded" />
            <Image src="/D4.jpg" alt="Product" width={70} height={70} className="border p-1 rounded" />
          </div>
        </div>
        ...
        <div className="col-span-8">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Brand: <span className="text-green-600">Lay's</span>
          </p>
      ...
      <div className="mt-10 border-b flex gap-6">
        <button
          onClick={() => setTab("desc")}
          className={`pb-2 ${tab === "desc" && "border-b-2 border-green-600 text-green-600"}`}
        >
          Description
        </button>
        ...
        <button
          ...
          className={`pb-2 ${tab === "review" && "border-b-2 border-green-600 text-green-600"}`}
        >
          Reviews (0)
        </button>
      </div>
      ...
      {tab === "desc" && (
        <div className="mt-6 text-gray-700 text-sm leading-relaxed space-y-4">
          <p>
            Lay's American Style Cream & Onion Potato Chips deliver a rich and creamy
            flavor blended with the perfect hint of onion. Made from carefully
            selected potatoes, these chips are thinly sliced and cooked to crispy
            perfection.
          </p>

          <p>
            These chips are ideal for parties, movie nights, or quick snacking.
            Packed in a hygienic and convenient pouch, they ensure freshness and
